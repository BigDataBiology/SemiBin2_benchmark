...
def plot_short_reads():
    ...
    print('Average strain improvement:', np.average(strain_improvement))
    print('Average species improvement:', np.average(species_improvement))
    print('Average genus improvement:', np.average(genus_improvement))
...
def plot_long_reads():
    ...
    for env in ['Skin','Oral','Airways','Gastrointestinal','Urogenital']:
        ...
        plt.close()
        plt.show()
    print('Average improvements:', np.average(improvements))
